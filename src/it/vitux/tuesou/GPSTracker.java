...
public Location getLocation() {
	...
	private LocationListener locationListener = new LocationListener() {
		...
		public void onStatusChanged(String provider, int status, Bundle extras) {
			if(status == LocationProvider.OUT_OF_SERVICE || status == LocationProvider.TEMPORARILY_UNAVAILABLE) {
				...
				//GPS NON DISPONIBILE -  TRACKING IN PAUSA - VISUALIZZA ALERT
			}
		}
	...
	public void requestLocation() {
		...
		if (this.isSupported() != null && this.isEnabled()) { 
			Location lastKnownLocation = locationManager.getLastKnownLocation(providerId); 
			if (lastKnownLocation != null) { 
				setLocation(lastKnownLocation);
			} 
			locationManager.requestLocationUpdates(providerId, 15, 0, locationListener);
		}
	}
	...
	public LocationProvider isSupported() {
